                        ...
                        <fieldset v-bind:disabled="loading">
                            <div class="mb-2 row">
                                <div class="col-md-8 offset-md-4">
                                    <button class="btn btn-success w-100 me-2" type="submit">Guardar</button>
                                </div>
                            </div>
                            <div class="mb-2 row">
                            ...
                            <div class="mb-2 row">
                                <label for="slug" class="col-md-4 col-form-label text-end">Slug</label>
                                <div class="col-md-8">
                                    <input name="slug" type="text" class="form-control" required title="Slug" pattern="[a-z0-9\-]+"
                                        placeholder="Slug" v-model="fields.slug">
                                </div>
                            </div>
