                ...
                <ul class="navbar-nav -2 mb-lg-0">
                    <?php if ($session->logged == TRUE) : ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="fal se">
                    ...
                    <?php else : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= URL_APP ?>accounts/login/link" role="button">
                                Ingresar
                            </a>
                        </li>
                    <?php endif; ?>
...
<script>
    ...
    nav1Elements.forEach(element => {
        ...
        if (element.sections.includes(appSection)) {
            element.active = true
        }
    ...
    const navbarApp = createApp({
        ...
        methods: {
            ...
            navClickSub: function(i, j) {
                ...
                this.elements[i].subelements.forEach(subelement => {
